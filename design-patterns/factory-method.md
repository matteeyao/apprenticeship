...
Of course, you can apply this approach to other UI elements as well. However, w/ each new factory method you add to the dialog, you get closer to the **Abstract Factory** pattern.
