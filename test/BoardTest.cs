...
namespace test
{
    ...
    public class BoardTest
    {
        ...
        [Test]
        public void FieldsAreEmptyOnInitialization()
        {
            string[] emptyBoard = { "1", "2", "3", "4", "5", "6", "7", "8", "9" };
            Assert.AreEqual(emptyBoard, _board.GetGrid());
        }
        ...
        {
            _board.SetField(4, "x");
            Assert.AreEqual("x", _board.GetField(4));
        }
        ...
        {
            bool isEmpty = true;
            Assert.AreEqual(true, _board.IsEmptyField(4));
            
            _board.SetField(4, "x");
            Assert.AreEqual(false, _board.IsEmptyField(4));
        }

        [Test]
        public void ReturnsDuplicateOfCurrentBoard()
        {
            Board dupedBoard = _board.Duplicate();
            Assert.AreNotEqual(dupedBoard, _board);
        }
